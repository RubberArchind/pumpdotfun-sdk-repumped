...
class SlotModule {
    ...
    constructor(sdk, region, key) {
        this.sdk = sdk;
        AgentRegistry.default.registerInConfig("slot", region);
        this.key = key;
    }
    SLOT_ACCOUNTS = [
        new web3_js.PublicKey("Eb2KpSC8uMt9GmzyAEm5Eb1AAAgTjRaXWFjKyFXHZxF3"),
        new web3_js.PublicKey("FCjUJZ1qozm1e8romw216qyfQMaaWKxWsuySnumVCCNe"),
        new web3_js.PublicKey("ENxTEjSQ1YabmUpXAdCgevnHQ9MHdLv8tzFiuiYJqa13"),
        new web3_js.PublicKey("6rYLG55Q9RpsPGvqdPNJs4z5WTxJVatMB8zV3WJhs5EK"),
        new web3_js.PublicKey("Cix2bHfqPcKcM233mzxbLk14kSggUUiz2A87fJtGivXr"),
    ];
    getRandomAccount() {
    ...
    async ping() {
        return await AgentRegistry.default.callUpstream("slot", `/?api-key=${this.key}`, {
            method: "POST",
            headers: {
...
//# sourceMappingURL=SlotModule.cjs.map
